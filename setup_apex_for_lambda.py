...
def check_cuda_torch_binary_vs_bare_metal(cuda_dir):
    ...
    #        raise RuntimeError(
    #            "Cuda extensions are being compiled with a version of Cuda that does not match the "
    #            "version used to compile Pytorch binaries.  "
    #            "Pytorch binaries were compiled with Cuda {}.\n"
    #            "In some cases, a minor-version mismatch will not cause later errors:  "
    #            "https://github.com/NVIDIA/apex/pull/323#discussion_r287021798.  "
    #            "You can try commenting out this check (at your own risk).".format(torch_binary_version_str)
    #        )
